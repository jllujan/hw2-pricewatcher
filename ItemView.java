...
public class ItemView extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		// --
		Item item = new Item("Macbook Pro", 2999.99, 2999.99, "https://www.bestbuy.com/site/apple-macbook-pro-13-display-intel-core-i5-8-gb-memory-128gb-flash-storage-space-gray/5721723.p?skuId=5721723");
		...
		y += 20;
		g.drawString("Change: " + item.getChange() + "%", x, y);
		y += 20;
